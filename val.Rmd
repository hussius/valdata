...
```{r:rf}
#komm$percChangeYouthUnempl <- 100*(komm$youthUnemployment2013-komm$youthUnemployment2010)/komm$youthUnemployment2010
#komm$percChangeUnempl <- 100*(komm$unemployment2013-komm$unemployment2010)/komm$unemployment2010
...
Surprisingly (?), latitude and longitude are shown as the most important features. Plot SD vote by lat/long:
...
C: Explained variance about 60%, proportion of tractors and degree of urbanness considered most important features.
